...
public class Voter {
    ...
    @ManyToMany(cascade = CascadeType.ALL)
    @JoinTable(name = "votation_voter", joinColumns = @JoinColumn(name = "votation_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "voter_id", referencedColumnName = "id"))
